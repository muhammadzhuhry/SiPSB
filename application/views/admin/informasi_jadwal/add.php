        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Form Tambah Jadwal Kegiatan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php
                echo form_open('admin/informasi_jadwal/add', 'role="form" class="form-horizontal"');
            ?>
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <div class="input-group">
                          <input type="text" id="input" name="tanggal_tes" class="form-control" />
